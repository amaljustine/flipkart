...
SECRET_KEY = 'django-insecure-_)5xifclwvpdzo7#s#c^c0l%#pqz#g#9v&rw1h3-fe7grwu#**'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['amaljustine.pythonanywhere.com']
...
AUTH_USER_MODEL = "flipkartapp.Users"
...
SWAGGER_SETTINGS = {
    ...
    'SECURITY_DEFINITIONS': {
        'Bearer': {
            ...
            'in': 'header',
            'name': 'Authorization',
            'description': 'Add token as: Bearer <your token>'
        }
    },
}
